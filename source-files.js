...
sourcesIndex["threescalers"] = {"name":"","dirs":[{"name":"http","dirs":[{"name":"request","files":["http.rs"]}],"files":["endpoints.rs","parameters.rs","request.rs"]}],"files":["api_call.rs","application.rs","credentials.rs","encoding.rs","errors.rs","extensions.rs","http.rs","lib.rs","response.rs","service.rs","timestamp.rs","transaction.rs","usage.rs","user.rs","version.rs"]};
